...
class Qwen2VLForConditionalGeneration(Qwen2VLPreTrainedModel, GenerationMixin):
    ...
    # 做你需要的事情
        ...
        self.input_wp_encoder  = MultiLayerEmbedding()
    ...
    def forward(
        ...
        if  input_waypoints is not None:
            ...
            for add_id in range(start_id,start_id+6):
                ...
                inputs_embeds = inputs_embeds.masked_scatter(input_waypoint_mask, input_waypoint_embedding)
        ...
        if gt_waypoints is None and arrive is None: 
            ...
            if train:
                ...
                if self.waypoint_direction_loss:
                    ...
                    total_loss = wp_loss + arrived_loss
                if self.predict_angle:
